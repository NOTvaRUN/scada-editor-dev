...
$jscomp.polyfill("Array.from", function(d) {
    return d ? d : function(d, l, p) {
        ...
        if ("function" == typeof z)
            for (d = z.call(d); !(z = d.next()).done;) h.push(l.call(p, z.value));
        else
            for (var z = d.length, B = 0; B < z; B++) h.push(l.call(p, d[B]));
        return h
    }
}, "es6-impl", "es3");
...
$jscomp.polyfill("Object.assign", function(d) {
    return d ? d : function(d, l) {
        for (var h = 1; h < arguments.length; h++) {
            var v = arguments[h];
            if (v)
                for (var z in v) $jscomp.owns(v, z) && (d[z] = v[z])
        }
        return d
    }
}, "es6-impl", "es3");
                    ...
                    for (var m = [], r = b[0].ymin; m.length || b.length;) {
                        ...
                        if (m = m.filter(function(a) {
                            ...
                            for (k = 0; k < m.length; k += 2) {
                                ...
                                if (g >= m.length) break;
                                f.push([
                                    [Math.round(m[k].edge.x), r],
                                    [Math.round(m[g].edge.x), r]
                                ])
                            }
                        r += a;
            ...
            for (b.s(); !(l = b.n()).done;) {
                ...
                switch (u) {
                    ...
                    case "A":
                        ...
                        else if (m !== L || x !== M) Y(m, x, L, M, I, J, K, N, O).forEach(function(a) {
                            g.push({
                                key: "C",
                                data: a
                            })
                    ...
                    value: function(a, e) {
                        ...
                        if (c.fill && "none" !== c.fill && 3 <= a.length) {
                            var h = ga(function(a) {
                                ...
                                var b = [];
                                if (3 === e) b.push(_toConsumableArray(a[0]), _toConsumableArray(a[1]), _toConsumableArray(a[2]), _toConsumableArray(a[2]));
                                else {
                                    e = [];
                                    e.push(a[0], a[0]);
            ...
            _createClass(b, [{
                    ...
                    value: function(a) {
                        var b = a.sets || [],
                            ...
                            k = d.createElementNS("http://www.w3.org/2000/svg",
                                "g"),
